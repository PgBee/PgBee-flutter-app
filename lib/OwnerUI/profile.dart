...
class _ProfilePageState extends State<ProfilePage> {
  ...
  Widget build(BuildContext context) {
    ...
    Widget editableField(TextEditingController controller, {bool isObscure = false, bool enableTap = false, VoidCallback? onTap}) => Padding(
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                // Profile image (square, rounded corners)
                Center(
                  child: Container(
